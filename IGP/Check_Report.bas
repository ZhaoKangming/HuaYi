...
' VBA word 商品名替换为通用名
    ...
    With Selection.Find
        .Text = "诺和灵30"
        .Replacement.Text = "精蛋白生物合成人胰岛素注射液(预混30）"
        .Forward = True
        .Wrap = wdFindAsk
        .Format = False
        .MatchCase = False
